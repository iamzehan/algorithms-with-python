...
moves["left_up"]= [[pos1+i, pos2-i] for i in range(1,min(pos1,pos2)) if pos1+i<=n]
moves["right_down"] = [[pos1-i, pos2+i] for i in range(1,pos1) if pos2+i<=n]
moves["left_down"] = [[pos1-i, pos2-i] for i in range(1,min(pos1,pos2))]
print(moves)
total=0
